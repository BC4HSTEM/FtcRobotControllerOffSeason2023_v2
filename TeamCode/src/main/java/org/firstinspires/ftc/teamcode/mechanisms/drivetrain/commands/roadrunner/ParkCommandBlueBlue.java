...
public class ParkCommandBlueBlue extends CommandBase {
    private final MecanumDriveSubsystem drive;
    private final Pose2d previousTrajEnd;
    private final Telemetry telemetry;

    private Vector2d position3 = new Vector2d(-58,8);
    private Vector2d position2 = new Vector2d(-37,8);
    private Vector2d postion1 = new Vector2d(-15,8);
    private Vector2d finalPosition = position3;

    TrajectoryFollowerCommand followPark;

    public ParkCommandBlueBlue(MecanumDriveSubsystem drive, Pose2d previousTrajEnd, Telemetry telemetry) {
        this.drive = drive;
    ...
    public void end(boolean interrupted) {
        ...
        telemetry.addLine("Park is ending");
        telemetry.update();
        followPark.schedule();
           // drive.stop();
    ...
    public boolean isFinished() {
        telemetry.addLine("Park is finished");
