...
public class RedAllianceNonStageSidePath2 {
    ...
    public RedAllianceNonStageSidePath2(HardwareMap hwMap, CreatePositionIdentifierMechanism mechanism, Pose2d sp, Telemetry telemetry){
        this.hwMap = hwMap;
    ...
    public RedAllianceNonStageSidePath2(HardwareMap hwMap, Pose2d sp, Telemetry telemetry){
        this.hwMap = hwMap;
        startPose = sp;
        this.telemetry = telemetry;
        drive = new MecanumDriveSubsystem(new SampleMecanumDrive(hwMap), false);
    ...
    public RedAllianceNonStageSidePath2(HardwareMap hwMap, Pose2d sp, FtcDashboard db, Telemetry telemetry){
        this.hwMap = hwMap;
    ...
    public void execute(CommandOpMode commandOpMode){
        commandOpMode.schedule(new WaitUntilCommand(commandOpMode::isStarted).andThen(
                ...
                detectTEPositionCommand.whenFinished(()->{
                    ...
                    if(createPositionIdentifierMechanism.getPosition() != Positions.TEPosition.POSITION_RIGHT){
                        ...
                        Trajectory traj2 = drive.trajectoryBuilder(traj1.end())
                                ...
                                .lineToLinearHeading(new Pose2d(-36, -53, Math.toRadians(0)))
                                //.lineToLinearHeading(new Pose2d(-36,-50, Math.toRadians(90)))
                                .build();
        ...
        *//*.lineToLinearHeading(new Pose2d(-36,-40, Math.toRadians(90)))
                ...
                //grabberWristPickUpCommand,detectTEPositionCommand.andThen(followPixel)));
